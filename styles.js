const styles = {
    ...
    paragraph: "font-poppins font-normal text-black text-[15px] leading-[30.8px]",
  
    paragraph1: "font-poppins font-normal justify-start text-black text-[16px] leading-[30.8px]",
